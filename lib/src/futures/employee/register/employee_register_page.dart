...
import 'package:dw_barbershop/src/futures/employee/register/employee_register_state.dart';
import 'package:dw_barbershop/src/futures/employee/register/employee_register_vm.dart';
    ...
    ref.listen(employeeRegisterVmProvider.select((state) => state.status),
      ...
      switch (status) {
        ...
        case EmployeeRegisterStateStatus.success:
          Messages.showSuccess('Colaborador cadastro com sucesso', context);
