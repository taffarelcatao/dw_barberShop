...
import 'package:dw_barbershop/src/futures/auth/register/barbershop/barbershop_register_state.dart';
import 'package:dw_barbershop/src/futures/auth/register/barbershop/barbershop_resgister_vm.dart';
...
class _BarbershopRegisterPageState
  ...
  Widget build(BuildContext context) {
    final barbershopRegisterVM =
        ref.watch(barbershopResgisterVmProvider.notifier);

    ref.listen(barbershopResgisterVmProvider, (_, state) {
      switch (state.status) {
